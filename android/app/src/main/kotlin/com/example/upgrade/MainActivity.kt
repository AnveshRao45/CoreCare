...
/**
 * Host activity for the Flutter UI.
 *
 * Extends [FlutterFragmentActivity] (required by Health Connect / Activity Result
 * APIs) and exposes a MethodChannel so Dart can open Health Connect settings.
 * Channel name must match [HealthService] in Dart.
 */
class MainActivity : FlutterFragmentActivity() {
    ...
    /**
     * Try to open Health Connect settings so the user can inspect permissions.
     *
     * Strategy (tries each in order until one works):
     *  1. Android 14+ system Health Connect settings activity
     *  2. The Health Connect APK launcher intent
